...
<!-- Players: LocalPlayer(USEC/local), <Opponent1>(USEC), <Opponent2>/<Opponent3>/<Opponent4>/<Opponent5>(BEAR) -->
...
```
── Fields of 'ObservedPlayer (Opp) '<Opponent1>' @ 0x[MASKED] (full hierarchy) ──
  ...
  │  [0xC0] string       <NickName>k__BackingField = "<Opponent1>"               ← PLAYER NAME (populated!)
  ...
  ┌ System.Object (klass=0x28540268090, 0 field(s))
── End of 'ObservedPlayer (Opp) '<Opponent1>' (7 class(es) in hierarchy) ──
```
...
> **Correction from previous doc**: `<NickName>k__BackingField` **IS populated** in Arena with the player's actual name (e.g. `"<Opponent1>"`, `"<Opponent5>"`, `"<Opponent3>"`, `"<Opponent2>"`, `"<Opponent4>"`). The `<AccountId>` field is empty (`""`), but `<NickName>` and `<ProfileId>` are valid.

> **`EPlayerSide` values**: `1=USEC`, `2=BEAR`, `4=Savage` — confirmed from live data (<Opponent1>=USEC=1, all BEARs=2). Previous docs had this reversed.
...
```
── Fields of 'ObservedPlayerController '<Opponent1>' @ 0x[MASKED] (full hierarchy) ──
  ...
  ┌ System.Object (klass=0x28540268090, 0 field(s))
── End of 'ObservedPlayerController '<Opponent1>' (3 class(es) in hierarchy) ──
```
...
```
── Fields of 'ObservedHealthController '<Opponent1>' @ 0x[MASKED] (full hierarchy) ──
...
── End of 'ObservedHealthController '<Opponent1>' (3 class(es) in hierarchy) ──
```
...
```
── Fields of 'ObservedMovementController '<Opponent1>' @ 0x[MASKED] (full hierarchy) ──
  ...
  ┌ System.Object (klass=0x28540268090, 0 field(s))
── End of 'ObservedMovementController '<Opponent1>' (2 class(es) in hierarchy) ──
```
...
```
── Fields of 'ObservedPlayerStateContext '<Opponent1>' @ 0x[MASKED] (full hierarchy) ──
  ...
  ┌ System.Object (klass=0x28540268090, 0 field(s))
── End of 'ObservedPlayerStateContext '<Opponent1>' (2 class(es) in hierarchy) ──
```
...
```
── Fields of 'ObservedInventoryController '<Opponent1>' @ 0x[MASKED] (full hierarchy) ──
  ...
  ┌ EFT.InventoryLogic.PersonItemController (klass=0x28541D69040, 1 field(s))
  │  [0x110] valuetype    Side = 1                                       ← 1=USEC (<Opponent1>)
  ┌ EFT.InventoryLogic.ItemController (klass=0x28541D698C0, 32 field(s))
  │  [0xD8] string        <ID>k__BackingField = "<profile_id_••••••••••••>"
  │  [0xF0] string        <Name>k__BackingField = "<Opponent1>"         ← PLAYER NAME via IC
  │  [0xE8] class         <RootItem>k__BackingField = 0x28A4B159000       ← root equipment item
── End of 'ObservedInventoryController '<Opponent1>' (5 class(es) in hierarchy) ──
```
...
```
── Fields of 'PlayerBody '<Opponent1>' @ 0x[MASKED] (full hierarchy) ──
  ...
  ┌ System.Object (klass=0x28540268090, 0 field(s))
── End of 'PlayerBody '<Opponent1>' (6 class(es) in hierarchy) ──
```
...
```
╔══════════════════════════════════════════════════════════════════════════
║ DATA CHAIN DUMP: ObservedPlayer '<Opponent1>' @ 0x[MASKED]  (observed=True)
╚══════════════════════════════════════════════════════════════════════════
── Rotation (4 hops) ──────────────────────────────────────────────────────
...
[RegisteredPlayers] Discovered: <Opponent2> (BEAR) @ <0, 0, 0> yaw=0.0° prof=[MASKED] @ 0x[MASKED] (local=False)
[RegisteredPlayers] Discovered: <Opponent3> (BEAR) @ <0, 0, 0> yaw=0.0° prof=[MASKED] @ 0x[MASKED] (local=False)
[RegisteredPlayers] Discovered: <Opponent4> (BEAR) @ <0, 0, 0> yaw=0.0° prof=[MASKED] @ 0x[MASKED] (local=False)
[RegisteredPlayers] Discovered: <Opponent5> (BEAR) @ <0, 0, 0> yaw=0.0° prof=[MASKED] @ 0x[MASKED] (local=False)
[RegisteredPlayers] Discovered: <Opponent1> (USEC) @ <0, 0, 0> yaw=0.0° prof=[MASKED] @ 0x[MASKED] (local=False)
```
...
```
[Il2CppDumper] ── Fields of 'ObservedPlayer (Opp) '<Opponent1>' @ ... ──
[Il2CppDumper] ── Fields of 'ObservedPlayerController '<Opponent1>' @ ... ──
[Il2CppDumper] ── Fields of 'ObservedHealthController '<Opponent1>' @ ... ──
[Il2CppDumper] ── Fields of 'ObservedMovementController '<Opponent1>' @ ... ──
[Il2CppDumper] ── Fields of 'ObservedPlayerStateContext '<Opponent1>' @ ... ──
[Il2CppDumper] ── Fields of 'ObservedInventoryController '<Opponent1>' @ ... ──
[Il2CppDumper] ── Fields of 'PlayerBody '<Opponent1>' @ ... ──
```
...
```
[RegisteredPlayers] Removed '<Opponent1>' (USEC) @ 0x[MASKED]
[RegisteredPlayers] Removed '<Opponent3>' (BEAR) @ 0x[MASKED]
```
