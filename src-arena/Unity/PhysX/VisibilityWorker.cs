    ...
    internal static class VisibilityWorker
    {
        ...
        private static void Tick(CancellationToken ct)
        {
            ...
            foreach (var p in gw.Players)
            {
                ...
                var targetHead   = ResolveBonePosition(p, eft_dma_radar.Arena.Unity.Bones.HumanHead,   EyeFallbackY);
                var targetChest  = ResolveBonePosition(p, eft_dma_radar.Arena.Unity.Bones.HumanSpine3, ChestFallbackY);
                var targetPelvis = ResolveBonePosition(p, eft_dma_radar.Arena.Unity.Bones.HumanPelvis, PelvisFallbackY);
        ...
        {
            var headBone = local.Skeleton?.GetBonePosition(eft_dma_radar.Arena.Unity.Bones.HumanHead);
        ...
        /// </summary>
        private static Vector3 ResolveBonePosition(Player p, eft_dma_radar.Arena.Unity.Bones bone, float fallbackY)
        {
